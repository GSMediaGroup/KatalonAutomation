...
WebUI.setText(findTestObject('Object Repository/Call to action/Page_AdRoot  Login/input_E-mail_email'), 'makronmanuel01@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Call to action/Page_AdRoot  Login/input_Password_password'), '9juLMCYi8sYpY2Mrwe5diw==')

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Login/button_Sign in'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Dashboard/img'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Dashboard/div_By Ruzan (app)'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Dashboard/a_Campaigns'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Campaigns/button_Create campaign'))
...
WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/div_autofill form_down'))
...
WebUI.setText(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/input_Headline_custom-input'), 
    'Create, Manage, Report and Collaborate on All Your Ads in One Place')

WebUI.setText(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/input_Ad Description_custom-input'), 
    'Create and manage everything in one place to boost the performance ')

WebUI.setText(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/input_Website URL_custom-input'), 
    'gsmediagroup.net')

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/div_Choose AD'))

WebUI.doubleClick(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/span_512 x 512'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/div_Share_edit'))

WebUI.click(findTestObject('Call to action/Page_AdRoot  Create Campaign Steps/div_No Button'))

WebUI.doubleClick(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/li_Sign Up'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/button_Save'))

WebUI.click(findTestObject('Object Repository/Call to action/Page_AdRoot  Create Campaign Steps/div_Open_delete'))
