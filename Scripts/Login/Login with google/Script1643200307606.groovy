...
WebUI.click(findTestObject('Object Repository/Login/Page_AdRoot  Login/span_Sign In'))

WebUI.switchToWindowTitle('Մտնել Google հաշիվներ')

WebUI.setText(findTestObject('Object Repository/Login/Page_Google/input_adroot.io_identifier'), 'ruzan.a@adroot.io')
