...
WebUI.click(findTestObject('Object Repository/Choose packages/Page_AdRoot  Sign up/button_Skip Payment'))

WebUI.click(findTestObject('Object Repository/Choose packages/Page_AdRoot  Dashboard/a_Campaigns'))

WebUI.click(findTestObject('Object Repository/Choose packages/Page_AdRoot  Campaigns/div_Create'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Choose packages/Page_AdRoot  Campaigns/div_You cant create campaign because on acc_55a7b4'), 
    0)

WebUI.click(findTestObject('Object Repository/Choose packages/Page_AdRoot  Campaigns/div_'))
