...
WebUI.navigateToUrl('https://dev2.adroot.io/auth/signin')
...
WebUI.click(findTestObject('Campaign copy/Page_AdRoot  Dashboard/img'))

WebUI.click(findTestObject('Campaign copy/Page_AdRoot  Dashboard/div_By Ruzan (dev)'))
