...
WebUI.click(findTestObject('Object Repository/Regular Create campaign/Create google ad/Page_AdRoot  Create Campaign Steps/div_Choose AD'))

WebUI.doubleClick(findTestObject('Object Repository/Regular Create campaign/Create google ad/Page_AdRoot  Create Campaign Steps/div_All_image-cont image'))
...
WebUI.click(findTestObject('Object Repository/Regular Create campaign/Create google ad/Page_AdRoot  Create Campaign Steps/div_Image Ad'))

WebUI.click(findTestObject('Object Repository/Regular Create campaign/Create google ad/Page_AdRoot  Create Campaign Steps/div_Choose AD'))

WebUI.doubleClick(findTestObject('Object Repository/Regular Create campaign/Create google ad/Page_AdRoot  Create Campaign Steps/div_Images_image-cont image'))

WebUI.click(findTestObject('Object Repository/Regular Create campaign/Create google ad/Page_AdRoot  Create Campaign Steps/button_Save'))
